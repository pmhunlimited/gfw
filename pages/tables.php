...
<div class="container py-5">
    ...
    <div class="row g-5">
        ...
        <div class="col-lg-6">
            ...
            <div class="bg-[#0a0e17] p-4 rounded-4 border border-white border-opacity-5 shadow-2xl overflow-hidden">
                <div id="widget-6tvwmll51mwx" class="scoreaxis-widget" style="width: auto;height: auto;font-size: 14px;background-color: #0a0e17;color: #ffffff;border: 1px solid;border-color: #1e293b;overflow: auto;">
                    <script src="https://widgets.scoreaxis.com/api/football/league-table/6232265abf1fa71a672159ec?widgetId=6tvwmll51mwx&lang=en&teamLogo=1&tableLines=1&homeAway=1&header=1&position=1&goals=1&gamesCount=1&diff=1&winCount=1&drawCount=1&loseCount=1&lastGames=1&points=1&teamsLimit=all&links=1&font=heebo&fontSize=14&rowDensity=100&widgetWidth=auto&widgetHeight=auto&bodyColor=%230a0e17&textColor=%23ffffff&linkColor=%23ff3e3e&borderColor=%231e293b&tabColor=%231e293b" async></script>
        ...
        <div class="col-lg-6">
            ...
            <div class="bg-[#0a0e17] p-4 rounded-4 border border-white border-opacity-5 shadow-2xl overflow-hidden">
                <div id="widget-0hh9mll529yu" class="scoreaxis-widget" style="width: auto;height: auto;font-size: 14px;background-color: #0a0e17;color: #ffffff;border: 1px solid;border-color: #1e293b;overflow: auto;">
